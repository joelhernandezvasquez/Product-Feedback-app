...
export const FeedbackItem = ({feedbackId,title,description,category,commentsAmount,views}) => {
  return (
    <li className="feedback-item primary-border-radius">
        
        <div className="feedback-item-header">
           <h2 className="feedback-item-title">{title}</h2> 
           <p className="feedback-item-description">{description}</p>
        ...
        <div className="feedback-item-views primary-border-radius d-flex d-flex-align-center">
          ...
          <p className="feedback-item-count">{views}</p> 
        </div>
